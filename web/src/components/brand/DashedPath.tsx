...
const presets: Record<string, { viewBox: string; d: string }> = {
...
export function DashedPath({ preset = "swoosh", color = "var(--color-signal-lime)", width = "100%", height, strokeWidth = 3, animate = false, style }: DashedPathProps) {
